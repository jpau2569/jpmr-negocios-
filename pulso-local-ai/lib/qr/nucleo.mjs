// ============================================================================
//  Fotos Fáciles — generador de códigos QR sin dependencias
// ----------------------------------------------------------------------------
//  Existe para que la app arranque sin `npm install` y sin internet: la pantalla
//  del ordenador tiene que pintar el QR aunque el PC esté aislado de la red.
//  Implementa QR modelo 2, modo byte (UTF-8), versiones 1-10 y niveles L/M/Q/H,
//  que sobra de largo para una URL de red local (`http://192.168.1.40:4321/m#t=…`).
//
