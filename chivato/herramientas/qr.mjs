// ============================================================================
//  Chivato AI — generador de códigos QR (copia de fotos-faciles/nucleo/qr.mjs)
// ----------------------------------------------------------------------------
//  Copia literal, no un enlace: `chivato/` tiene que poder desplegarse sola sin
//  arrastrar el resto del monorepo. El test comprueba que sigue siendo idéntica
//  al original, para que un arreglo allí no se quede aquí sin aplicar.
//  Implementa QR modelo 2, modo byte (UTF-8), versiones 1-10 y niveles L/M/Q/H,
//  de sobra para una URL corta como `https://chivato.ai`.
//
