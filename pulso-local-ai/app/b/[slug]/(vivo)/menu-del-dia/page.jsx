...
export default async function PaginaMenuDia({ params, searchParams }) {
    ...
    return (<div className="py-6">
      ...
      {espacio.menuDeHoy ? (<MenuDelDia espacio={espacio}/>) : (<div className="mx-auto w-full max-w-3xl px-4 sm:px-6">
