    ...
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {PUNTOS.map((punto) => {
          ...
          return (
            <Tarjeta key={punto.token} className="p-4">
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs">
                <a href={`${api}&formato=png&escala=12`} download
                   className="rounded-full bg-[#d4a03c] px-3 py-1.5 font-semibold text-[#17181b]">
                  PNG
                </a>
                <a href={`${api}&formato=svg`} download
                   className="rounded-full border border-white/15 px-3 py-1.5">
                  SVG
                </a>
                <a href={`${api}&formato=a5`} target="_blank" rel="noopener"
                   className="rounded-full border border-white/15 px-3 py-1.5">
                  Cartel A5
                </a>
                <a href={`${api}&formato=mesa`} target="_blank" rel="noopener"
                   className="rounded-full border border-white/15 px-3 py-1.5">
                  Pegatina de mesa
                </a>
              </div>
